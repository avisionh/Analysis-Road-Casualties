...
One suspects that Weather and RoadSurface intrinsically related so not going to include both together in analysis to avoid double-counting.
...
1. From the *Fatal* and *Serious* incidences of casaulty, the *Driver/Rider* and *Pedestrians* were more likely to suffer these than a *Passenger* would. This could be for a varity of reasons This corroborates point (1.) earlier.
...
## Next Steps
To take this analysis further, enough variables have been covered to provide a good starting point for choosing variables to include in a classification model to understand the groups of people more at risk of road casualties in the London Borough of Camden. These variables can be:
...
Even more powerful is building a predictive model such as a multi-linear regression or a random forest to understand the impacts the following variables can have on road casualty:
